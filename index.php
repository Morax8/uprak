...
<head>
    ...
    <link rel="stylesheet" href="./Page/navbar/css/bootstrap.min.css">
                                    ...
                                    <div class="center-wrap">
                                        <form action="" method="POST">
                                            <div class="section text-center">
                                                ...
                                                <div class="form-group mt-2">
                                                    <input type="text" class="form-style" name="email" placeholder="Email" value="<?php echo isset($email) ? $email : ''; ?>" required>
